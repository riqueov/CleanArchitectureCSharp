...
namespace CleanArchMvc.Domain.Tests
{
    public class ProductUnitTest1
    {
        ...
        {
            Action action = () => new Product(1, "Product Name", "Description of product", 150.00m, "Size", "Color", 5, "productImage.jpg");
        ...
        {
            Action action = () => new Product(1, "PN", "Description of product", 150.00m, "Size", "Color", 5, "productImage.jpg");
            action.Should().Throw<Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new Product(1, "ProductName", "De", 150.00m, "Size", "Color", 5, "productImage.jpg");
            action.Should().Throw<Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new Product(1, "", "Description of product", 150.00m, "Size", "Color", 5, "productImage.jpg");
            action.Should().Throw<Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new Product(1, "Product Name", "", 150.00m, "Size", "Color", 5, "productImage.jpg");
            action.Should().Throw<Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new Product(1, null, "Description of product", 150.00m, "Size", "Color", 5, "productImage.jpg");
            action.Should().Throw<Validation.DomainExceptionValidation>();
        }
        ...
        {
            Action action = () => new Product(1, "Product Name", null, 150.00m, "Size", "Color", 5, "productImage.jpg");
            action.Should().Throw<Validation.DomainExceptionValidation>();
        }
        ...
        {
            Action action = () => new Product(1, "Product Name", "Description of product", 150.00m, "Size", "Color", 5,
        ...
        {
            Action action = () => new Product(1, "Product Name", "Description of product", 150.00m, "Size", "Color", 5, null);
            action.Should().NotThrow<Validation.DomainExceptionValidation>();
        }
        ...
        {
            Action action = () => new Product(1, "Product Name", "Description of product", -150.00m, "Size", "Color", 5, "imageProduct.jpg");
            action.Should().Throw<Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new Product(1, "Product Name", "Description of product", 150.00m, "Size", "Color", value, "imageProduct.jpg");
            action.Should().Throw<Validation.DomainExceptionValidation>()
